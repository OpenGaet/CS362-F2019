...
////////////////////////////////////////////////
///// Refactored Functions for Card Effects/////
...
int effectMinion(int choice1, int choice2, struct gameState *state, int handPos, int currentPlayer)
{
    int i;
    int j;
    //+1 action
...
int effectAmbassador(int choice1, int choice2, struct gameState *state, int handPos, int currentPlayer)
{
    int i;
...
int effectTribute(struct gameState *state, int currentPlayer, int nextPlayer)
{
    int i;
...
int effectMine(int choice1, int choice2, struct gameState *state, int handPos, int currentPlayer)
{
    int i;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    // REFACTORED /////////////////////////////////////////
    case mine:
        return effectMine(choice1, choice2, state, handPos, currentPlayer);
    ...
    // REFACTORED /////////////////////////////////////////
    case baron:
        return effectBaron(choice1, state, currentPlayer);
    ...
    // REFACTORED /////////////////////////////////////////
    case minion:
        return effectMinion(choice1, choice2, state, handPos, currentPlayer);
    ...
    // REFACTORED /////////////////////////////////////////
    case tribute:
        return effectTribute(state, currentPlayer, nextPlayer);

    // REFACTORED /////////////////////////////////////////
    case ambassador:
        return effectAmbassador(choice1, choice2, state, handPos, currentPlayer);
